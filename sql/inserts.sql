...
-- =====================================================================
-- 1️⃣ INSERCIÓN DE EMPRESAS
-- =====================================================================

INSERT INTO Empresa (RazonSocial, RUC, Sector, Direccion, Telefono, Email) VALUES
('Transportes Rápidos SAC', '20123456789', 'Transporte de Carga', 'Av. Industrial 123, Lima', '01-2345678', 'contacto@rapidossac.com'),
('Logística del Sur EIRL', '20987654321', 'Logística', 'Jr. Comercio 456, Arequipa', '054-234567', 'info@logisticasur.com'),
('Distribuidora Norte SA', '20456789123', 'Distribución', 'Av. Grau 789, Trujillo', '044-345678', 'ventas@distrinorte.com'),
('Servicios Express Perú', '20321654987', 'Mensajería', 'Calle Lima 321, Cusco', '084-456789', 'servicios@expressperu.com');
GO

-- =====================================================================
-- 2️⃣ INSERCIÓN DE VEHÍCULOS
-- =====================================================================
...
-- =====================================================================
-- 3️⃣ INSERCIÓN DE TÉCNICOS
-- =====================================================================

INSERT INTO Tecnico (Nombre, Apellido, DNI, Especialidad, Certificacion, Telefono, Email) VALUES
('Carlos', 'Mendoza', '12345678', 'Mecánica Diesel', 1, '987654321', 'cmendoza@tech.com'),
('Ana', 'García', '23456789', 'Electricidad Automotriz', 1, '987654322', 'agarcia@tech.com'),
('Luis', 'Rodríguez', '34567890', 'Transmisión y Frenos', 1, '987654323', 'lrodriguez@tech.com'),
('María', 'Torres', '45678901', 'Mecánica General', 0, '987654324', 'mtorres@tech.com'),
('Jorge', 'Ramírez', '56789012', 'Sistemas Hidráulicos', 1, '987654325', 'jramirez@tech.com'),
('Patricia', 'Flores', '67890123', 'Diagnóstico Electrónico', 1, '987654326', 'pflores@tech.com');
GO

-- =====================================================================
-- 4️⃣ INSERCIÓN DE COMPONENTES
-- =====================================================================
...
(1, 'Transmisión I-Shift', 'Transmision', '2020-01-15', 400000, 'Bueno'),
(1, 'Sistema de Frenos ABS', 'Frenos', '2020-01-15', 200000, 'Excelente'),
(2, 'Motor Scania DC13', 'Motor', '2021-03-20', 500000, 'Excelente'),
(2, 'Suspensión Neumática', 'Suspension', '2021-03-20', 300000, 'Bueno'),
(3, 'Motor OM471', 'Motor', '2019-05-10', 500000, 'Regular'),
(3, 'Sistema Eléctrico 24V', 'Electrico', '2019-05-10', 250000, 'Malo'),
(4, 'Motor 2.8L Turbo', 'Motor', '2022-02-15', 300000, 'Excelente'),
(5, 'Transmisión Manual 6V', 'Transmision', '2021-06-20', 250000, 'Bueno'),
(6, 'Neumáticos Michelin', 'Neumaticos', '2023-01-10', 80000, 'Bueno');
GO

-- =====================================================================
-- 5️⃣ INSERCIÓN DE MANTENIMIENTOS
-- =====================================================================
...
(1, 3, '2024-02-20 09:30:00', 'Preventivo', 1200.00, 'Revisión de frenos y suspensión', 42000, 180, 'Completado'),
(2, 1, '2024-01-10 10:00:00', 'Preventivo', 900.00, 'Mantenimiento programado 30000km', 30000, 150, 'Completado'),
(3, 2, '2024-03-01 08:30:00', 'Correctivo', 3500.00, 'Reparación sistema eléctrico - falla en alternador', 65000, 480, 'Completado'),
(3, 2, '2024-03-10 14:00:00', 'Correctivo', 2800.00, 'Reemplazo de batería y cableado', 65500, 240, 'Completado'),
(4, 4, '2024-02-05 11:00:00', 'Preventivo', 650.00, 'Cambio de aceite y rotación de neumáticos', 14000, 90, 'Completado'),
(5, 3, '2024-01-25 13:00:00', 'Preventivo', 1100.00, 'Revisión de transmisión y embrague', 27000, 200, 'Completado'),
(6, 5, '2024-02-28 09:00:00', 'Correctivo', 1800.00, 'Reparación de sistema hidráulico', 41000, 300, 'Completado'),
(7, 1, '2024-03-05 08:00:00', 'Preventivo', 950.00, 'Mantenimiento preventivo general', 17000, 140, 'Completado'),
(8, 6, '2024-02-15 10:30:00', 'Predictivo', 450.00, 'Diagnóstico electrónico preventivo', 34000, 60, 'Completado'),
(1, 2, '2024-03-15 15:00:00', 'Correctivo', 2200.00, 'Reparación sensor de temperatura', 44000, 180, 'Completado'),
(2, 4, '2024-03-08 11:30:00', 'Preventivo', 780.00, 'Cambio de filtros de aire y combustible', 31500, 100, 'Completado'),
(3, 1, '2024-03-20 08:00:00', 'Correctivo', 4500.00, 'Overhaul de motor - reparación mayor', 67000, 960, 'En proceso'),
(4, 3, '2024-03-12 14:30:00', 'Preventivo', 890.00, 'Alineación y balanceo', 15000, 120, 'Completado'),
(11, 5, '2024-02-10 09:00:00', 'Correctivo', 8500.00, 'Reconstrucción de transmisión', 92000, 1200, 'Completado'),
(12, 2, '2024-03-18 10:00:00', 'Correctivo', 1950.00, 'Reparación de sistema de inyección', 57500, 360, 'En proceso');
GO

-- =====================================================================
-- 6️⃣ INSERCIÓN DE PLANES DE MANTENIMIENTO
-- =====================================================================
...
(2, '2024-04-20', 'Preventivo', 40000, 'Revisión general y cambio de aceite', 'Pendiente'),
(4, '2024-04-10', 'Preventivo', 20000, 'Mantenimiento 20000km', 'Pendiente'),
(5, '2024-04-25', 'Preventivo', 35000, 'Revisión de transmisión', 'Pendiente'),
(6, '2024-05-01', 'Preventivo', 50000, 'Mantenimiento mayor', 'Pendiente'),
(7, '2024-04-18', 'Preventivo', 25000, 'Servicio programado', 'Pendiente'),
(8, '2024-04-22', 'Predictivo', 40000, 'Análisis predictivo de componentes', 'Pendiente'),
...
(1, '2024-03-01', 'Preventivo', 45000, 'Revisión trimestral', 'Ejecutado');
GO

-- =====================================================================
-- 7️⃣ INSERCIÓN DE USUARIOS
-- =====================================================================

INSERT INTO Usuario (EmpresaID, NombreUsuario, Contrasena, Nombre, Apellido, Email, Rol) VALUES
(1, 'admin.rapidos', 'hash_password_123', 'Roberto', 'Sánchez', 'rsanchez@rapidossac.com', 'Administrador'),
...
(3, 'admin.norte', 'hash_password_012', 'Carmen', 'Díaz', 'cdiaz@distrinorte.com', 'Administrador'),
...
(NULL, 'consulta.general', 'hash_password_901', 'Andrea', 'López', 'alopez@flotia.com', 'Consulta');
GO

-- =====================================================================
-- 8️⃣ INSERCIÓN DE REPORTES
-- =====================================================================
...
(4, 'Rendimiento de Técnicos', 'Mes: Marzo 2024', 'Promedio satisfacción: 4.5/5');
GO

-- =====================================================================
-- 9️⃣ CONSULTAS DE VERIFICACIÓN
-- =====================================================================
...
PRINT 'Total de Vehículos: ';
SELECT COUNT(*) AS Total FROM Vehiculo;
PRINT '';

PRINT 'Total de Técnicos: ';
...
PRINT 'Costos de Mantenimiento por Vehículo (Top 5):';
